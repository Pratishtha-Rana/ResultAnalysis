...
public class MentorPage extends HttpServlet{
      ...
      throws ServletException, IOException {
		...
		try {
			...
			String id=request.getParameter("uname").substring(7,15);
            System.out.println(id);
			Statement smt1=conn.createStatement();
			String s1="select * from mentor where mentor = '"+id+"'";
			...
			String s2="select * from CSE2_marks where studentid='"+id+"'";
