...
public class TeacherPage extends HttpServlet{
      ...
      throws ServletException, IOException {
		...
		try {
			...
			if (rs.next())
			{
				out.println("<html><body><p><b>Name : "+rs.getString("teacherid")+"<br>Department:"+ rs.getString("department"));
				out.println("<b><br> classes Handeled</b><ol>");
				while(rs2.next())
				{
					out.println("<a href='teacherchoice.html'><li>"+rs2.getString("class")+"</li></a>");
				}
				out.println("</ol><br>");
