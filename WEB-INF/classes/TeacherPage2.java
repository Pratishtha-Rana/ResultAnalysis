...
public class TeacherPage2 extends HttpServlet{
      ...
      //  Database credentials
		...
		try {
			...
			if (rs.next())
			{
				out.println("<html><head>"+cssTag+"</head><body><p class='teacher'><b>Name: "+rs.getString("teacherid")+"<br>Department: "+ rs.getString("department"));
